...
enum class SensorNeeds( val id: Int, val count: Int, val oneValueTextView: Int,
    ...
    ACC(Sensor.TYPE_LINEAR_ACCELERATION, 3, PLOT, UnitsMetricSystem.acceleration, "t_Android;t_unix;x;y;z;a\n", ImperialConversion.DEBUG, R.string.acc_name),
    ACG(Sensor.TYPE_ACCELEROMETER, 3, PLOT, UnitsMetricSystem.acceleration, "t_Android;t_unix;x;y;z;a\n", ImperialConversion.DEBUG, R.string.acg_name),
    AGG(Sensor.TYPE_GRAVITY, 3, PLOT, UnitsMetricSystem.acceleration, "t_Android;t_unix;x;y;z;a\n", ImperialConversion.DEBUG, R.string.agg_name),
    GYRO(Sensor.TYPE_GYROSCOPE, 3, PLOT, UnitsMetricSystem.angle_acceleration, "t_Android;t_unix;x;y;z;a\n", ImperialConversion.DEBUG, R.string.gyro_name),
    HUM(Sensor.TYPE_RELATIVE_HUMIDITY, 1, PLOT, UnitsMetricSystem.percentage, "t_Android;t_unix;hum;a\n", ImperialConversion.DEBUG, R.string.humi_name),
    MAGNET(Sensor.TYPE_MAGNETIC_FIELD, 3, PLOT, UnitsMetricSystem.induction, "t_Android;t_unix;x;y;z;a\n", ImperialConversion.DEBUG, R.string.magnet_name),
    PROXIMITY(Sensor.TYPE_PROXIMITY, 1, TEXTVIEW, UnitsMetricSystem.centimeter, "t_Android;t_unix;prox;a\n", ImperialConversion.DEBUG, R.string.proxi_name),
    ROTATION(Sensor.TYPE_ROTATION_VECTOR, 4, PLOT, UnitsMetricSystem.nothing, "t_Android;t_unix;x;y;z;0;a\n", ImperialConversion.DEBUG, R.string.rotation_name),
    PRESSURE(Sensor.TYPE_PRESSURE, 1, PLOT, UnitsMetricSystem.pressure, "t_Android;t_unix;pressure;a\n", ImperialConversion.DEBUG, R.string.pressure_name),
    LIGHT(Sensor.TYPE_LIGHT, 1, PLOT, UnitsMetricSystem.lux,"t_Android;t_unix;light;a\n", ImperialConversion.DEBUG, R.string.light_name),
    TEMP(Sensor.TYPE_AMBIENT_TEMPERATURE, 1, PLOT, UnitsMetricSystem.celsius, "t_Android;t_unix;temp;a\n", ImperialConversion.DEBUG, R.string.temp_name),
    STEP_COUNTER(Sensor.TYPE_STEP_COUNTER, 1, TEXTVIEW, UnitsMetricSystem.steps_string, "t_Android;t_unix;steps;a\n", ImperialConversion.DEBUG, R.string.step_counter_name),
    STEP_DETECTOR(Sensor.TYPE_STEP_DETECTOR, 1, REALTIME_COUNTER, UnitsMetricSystem.steps_string, "t_Android;t_unix;steps;a\n", ImperialConversion.DEBUG, R.string.step_detector_name),
    @SuppressLint("InlinedApi")
    HEART_RATE(Sensor.TYPE_HEART_RATE, 1, TEXTVIEW, UnitsMetricSystem.heartrate, "t_Android;t_unix;bpm;a\n", ImperialConversion.DEBUG, R.string.heart_rate),

    ACC_WEAR(Sensor.TYPE_LINEAR_ACCELERATION, 3, PLOT, UnitsMetricSystem.acceleration, "t_Android;t_unix;x;y;z;a\n", ImperialConversion.DEBUG, R.string.acc_name_wear),
    ACG_WEAR(Sensor.TYPE_ACCELEROMETER, 3, PLOT, UnitsMetricSystem.acceleration, "t_Android;t_unix;x;y;z;a\n", ImperialConversion.DEBUG, R.string.acg_name_wear),
    GYRO_WEAR(Sensor.TYPE_GYROSCOPE, 3, PLOT, UnitsMetricSystem.angle_acceleration, "t_Android;t_unix;x;y;z;a\n", ImperialConversion.DEBUG, R.string.gyro_name_wear),
    MAGNET_WEAR(Sensor.TYPE_MAGNETIC_FIELD, 3, PLOT, UnitsMetricSystem.induction, "t_Android;t_unix;x;y;z;a\n", ImperialConversion.DEBUG, R.string.magnet_name_wear),

    @SuppressLint("InlinedApi")
    HEART_RATE_WEAR(Sensor.TYPE_HEART_RATE, 1, TEXTVIEW, UnitsMetricSystem.heartrate, "t_Android;t_unix;bpm;a\n", ImperialConversion.DEBUG, R.string.heart_rate_wear);
