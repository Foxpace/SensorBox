...
object WearOsConstants {
    ...
    const val START_WEAR_SENSOR_REAL_TIME = "START_WEAR_SENSOR_REAL_TIME"
    const val END_WEAR_SENSOR_REAL_TIME = "END_WEAR_SENSOR_REAL_TIME"
    const val SEND_WEAR_SENSOR_INFO = "SEND_WEAR_SENSOR_INFO"
    const val SEND_WEAR_SENSOR_INFO_EXTRA = "SEND_WEAR_SENSOR_INFO_EXTRA"

    const val ACG_SAMPLE = "ACG_SAMPLE"
    const val ACC_SAMPLE = "ACC_SAMPLE"
    const val GYRO_SAMPLE = "GYRO_SAMPLE"
    const val MAGNETIC_SAMPLE = "MAGNETIC_SAMPLE"
