...
class SettingsPickerAdapter(private val context: Context, private val prefKey: String, private val optionsText: Array<String>) :
    ...
    private inner class ViewHolder(itemView: View, var speed: Int = 0) : RecyclerView.ViewHolder(itemView) {
        init {
            itemView.setOnClickListener{view ->
                ...
                this@SettingsPickerAdapter.position = speed
